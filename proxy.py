...
PATH_TO_PORT = {
    "/multimodal": config.multimodal_port,   # 第一个应用：前缀为/multimodal，转发到8080端口
    "/api": config.main_port,    # 第二个应用：前缀为/api，转发到5000端口
    "/webapp": config.web_port  # Streamlit：前缀为/webapp，转发到8501端口
}
